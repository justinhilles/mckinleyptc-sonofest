...
const stageSchedules = [
  ...
  },
  {
    ...
    slots: [
      { time: '11:30 AM - 12:10 PM', artist: 'Whiskey & Burlap', instagram: getInstagramHandle('Whiskey & Burlap') },
      { time: '12:30 PM - 1:10 PM', artist: 'Ypsitucky', instagram: getInstagramHandle('Ypsitucky') },
      { time: '1:15 PM', artist: 'Chili Winner - Judges', isChiliWinner: true },
      { time: '1:30 PM - 2:15 PM', artist: 'Amandas', instagram: getInstagramHandle('Amandas') },
      { time: '2:30 PM - 3:10 PM', artist: 'Chloe Lou & The Liddells', instagram: getInstagramHandle('Chloe Lou & The Liddells') },
      { time: '3:20 PM', artist: "Chili Winner - People's Choice", isChiliWinner: true },
      { time: '3:30 PM - 4:10 PM', artist: 'Shawn Rohlf & The Buskers', instagram: getInstagramHandle('Shawn Rohlf & The Buskers') },
      { time: '4:20 PM - 4:50 PM', artist: 'Julia Sage & The Bad Hombres', instagram: getInstagramHandle('Julia Sage & The Bad Hombres') },
    ],
  },
];
